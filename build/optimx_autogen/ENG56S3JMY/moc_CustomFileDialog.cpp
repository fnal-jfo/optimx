...
#include "../../../Dialogs/include/CustomFileDialog.h"
...
static constexpr auto qt_meta_stringdata_ZN16CustomFileDialogE = QtMocHelpers::stringData(
    "CustomFileDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16CustomFileDialogE[] = {
...
Q_CONSTINIT const QMetaObject CustomFileDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16CustomFileDialogE.offsetsAndSizes,
    qt_meta_data_ZN16CustomFileDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16CustomFileDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *CustomFileDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16CustomFileDialogE.stringdata0))
