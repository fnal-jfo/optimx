...
#include "../../../Dialogs/include/FindDialog.h"
...
Q_CONSTINIT const QMetaObject FindDialog::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10FindDialogE_t,
        ...
        QtPrivate::TypeAndForceComplete<FindNextData const &, std::false_type>,
        // method 'accept'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'next'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
...
void FindDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->findNext((*reinterpret_cast< std::add_pointer_t<FindNextData>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FindDialog::*)(FindNextData const & );
...
// SIGNAL 0
void FindDialog::findNext(FindNextData const & _t1)
{
