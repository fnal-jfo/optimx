...
struct LatticeDlgStruct {
  ...
  LatticeDlgStruct();
  LatticeDlgStruct(  LatticeDlgStruct const& o);
  LatticeDlgStruct&  operator=( LatticeDlgStruct const& rhs);
  
};

class LatticeDialog: public QDialog {
...
Q_OBJECT
 ...
 public:
  ...
  virtual ~LatticeDialog();

  LatticeDlgStruct  data_;
