...
#ifndef EDITORPREFERENCESDIALOG_H
#define EDITORPREFERENCESDIALOG_H
...
Q_OBJECT
 ...
 public:
           ...
           EditorPreferencesDialog( QWidget* parent);
  ...
  EditorPreferences data_;


 private slots:
    
  void selectBackgroundHighlightColor(); 
  void selectForegroundHighlightColor(); 
  void selectFont(); 
  void showEvent(QShowEvent * event);
   
 private:

  Ui::EditorPreferencesDialog* ui_;

};

#endif    // EDITORPREFERENCESDIALOG_H
