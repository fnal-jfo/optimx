...
#include <ui_ptracking_dialog.h>    

//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||

PTrackingDialog::PTrackingDialog(QWidget* parent)
  : QDialog(parent), ui_(new Ui::PTrackingDialog()) 
{
  ui_->setupUi(this);
}
...
PTrackingDialog::~PTrackingDialog()
{}

//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||

void PTrackingDialog::accept()
{
  data_.MatchCase = ui_->checkBoxMatchCase->isChecked();
  data_.printname = ui_->checkBoxPrintName->isChecked();
  data_.Step      = ui_->doubleSpinBoxSteps->value();
