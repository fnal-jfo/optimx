...
void OptimMainWindow::cmdView4DBeta ()
{
...
void OptimMainWindow::Betas4D (Twiss4D& v)
{
  ...
  curvespecs.push_back({ "Beta1X",    &x[0], &y[0][0], k, QwtSymbol::NoSymbol, QwtPlot::yLeft,   "Beta_1X & Beta_2Y[m]", 0 });  
  curvespecs.push_back({ "Beta2Y",    &x[0], &y[1][0], k, QwtSymbol::NoSymbol, QwtPlot::yLeft,   "Beta_1X & Beta_2Y[m]", 0 });  
  curvespecs.push_back({ "Beta1Y",    &x[0], &y[2][0], k, QwtSymbol::NoSymbol, QwtPlot::yRight,  "Beta_2X & Beta_1Y[m]", 0 });  
  curvespecs.push_back({ "Beta2X",    &x[0], &y[3][0], k, QwtSymbol::NoSymbol, QwtPlot::yRight,  "Beta_2X & Beta_1Y[m]", 0 });  
