...
TrackerParameters::TrackerParameters( TrackerParameters const& o)
:
    dataspec(o.dataspec),
    nturns(o.nturns),
    ielm(o.ielm),
...
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
  ...
  TrackerParameters& TrackerParameters::operator=( TrackerParameters const& rhs)
  {
    if  (&rhs == this) return *this;
 
    dataspec =  rhs.dataspec;
    nturns   =  rhs.nturns;
    ielm      = rhs.ielm;
