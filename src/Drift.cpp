...
Drift::Drift(const char* nm, char const* fnm) : Element(nm,fnm) {}

//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||

Drift::Drift(Drift const& o) : Element(o) {}
...
//RMatrix Drift::rmatrix(double& energy, double& ms, double& tetaY, double dalfa, RMatrix* tmat_, int st)
//{ } 

//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||

void Drift::setParameters( int np, double dat[], ... )
{ 
...
void Drift::setParameters( int np, std::vector<double> const& dat, ... )
{ 
...
void Drift::toString( char* buf) const
{
...
int Drift::trackOnce( double ms,   double& Enr0, int n_elem, int n_turn, TrackParam& prm,
...
RMatrix Drift::rmatrixsc(double& alfap, double& energy, double ms, double current, BeamSize& bs,double& tetaY, double dalfa, int st ) const
{
...
RMatrix  Drift::rmatrix( RMatrix_t<3>& frame, double& energy, double ms, int st) const
{
