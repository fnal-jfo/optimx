...
#ifndef TRACKERPLOT_H
#define TRACKERPLOT_H
...
class TrackerPlot : public QwtPlot {

 public:
  TrackerPlot(QWidget* parent=0);

  void enableZoomMode( bool on);
  void fixedLimits(QwtAxis::Position axisid);
  void setOptions(QwtAxis::Position axisid);
  void setPlane(PlaneType t);
...
private:
  ...
  QVector<double>              vxy_;
  std::unique_ptr<Histogram2D> hxy_;
